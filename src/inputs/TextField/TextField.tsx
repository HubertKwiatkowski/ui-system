...
export const TextField = (props: TextFieldProps) => {
  ...
  const errorWrapper =
    props.error && !props.disabled ? styles.errorWrapper : "";
  ...
  const iconLeftClasses = [styles.baseIcon, styles.leftIcon].join(" ");

  const iconRightClasses = [styles.baseIcon, styles.rightIcon].join(" ");
